...
const Search = ({ landing, searchChange, searchChangeLanding }) => {
  ...
  return (
    <div
      className={
        landing ? "landing search__bar--wrapper" : "search__bar--wrapper"
      }
    >
      <h1 className="search__title">
        {landing ? (
          <>
            ...
            <span className="title__span">Movie Subscription Platform</span>
          </>
        ) : (
          "Browse Movies"
        )}
      ...
      {landing ? (
        <h2 className="search__sub-title">
          ...
          <span className="sub__title--span">MoviePix</span>
        </h2>
      ) : null}
      <div className="input__wrapper">
        <input
          ...
          onKeyDown={(event) =>
            event.key === "Enter" &&
            (landing ? searchChangeLanding(event) : searchChange(event))
          }
          type="text"
          id="search__entered"
